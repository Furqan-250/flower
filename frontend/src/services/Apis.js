...
const apis = {
  ...
  GET_CLASSES_DETAILS: "/api/v1/admin/getAllClasses",
  REMOVE_SUBJECT: "/api/v1/admin/removeSubject",
  UNBLOCK_SUBJECT: "/api/v1/admin/unblockSubject",
  REMOVE_CLASSES: "/api/v1/admin/removeClasses",
  UNBLOCK_CLASSES: "/api/v1/admin/unblockClasses",
  ADD_TEACHER: "/api/v1/admin/register",
  ADD_SUBJECT: "/api/v1/admin/addSubject",
  ADD_CLASS: "/api/v1/admin/addClasses",
};
